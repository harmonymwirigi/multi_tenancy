...
from .views import listviews, addviews, updateviews, deleteviews, statviews, fileviews, individual_finances, pledges

# TODO add delete views
urlpatterns = [
    #individual finances
    path('member-tithes/', individual_finances.MemberTithes.as_view()),
    path('tithes-statistics/', individual_finances.TitheStats.as_view()),
    path('offering-statistics/', individual_finances.OfferingStats.as_view()),
    path('member-offerings/', individual_finances.MemberOfferings.as_view()),
    # listing
    ...
    path('preview-csv/<int:file_id>/', addviews.PreviewCSV.as_view()),
    ...
    #delete.
    path('delete-envelopes/',deleteviews.deleteEnvelope.as_view()),
    ...
    #pledge payments
    path('upload-pledge-payments-csv/', pledges.UploadCSV.as_view()),
    path('check-pledge-payments-csv/', pledges.CheckCSV.as_view()),
    path('preview-pledge-payments-csv/<int:file_id>/', pledges.PreviewCSV.as_view()),
    path('import-pledge-payments-data-from-csv/', pledges.ImportDataFromCsv.as_view()),
