...
from .views import listviews, addviews, detailviews, updateviews ,deleteviews,statviews, authviews
...
urlpatterns = [
    ...
    path('generate-otp/', authviews.GenerateOTP.as_view()),
    path('login-with-otp/', authviews.LoginWithOTP.as_view()),
